...
def cleanitup(url):
        number = url.index("</span") #Finds out where </span begins in the string returned from google
        conversionresult = url[0:number] #Wipes everything after </span, as it's useless information
